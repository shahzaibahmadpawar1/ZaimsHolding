          ...
          <FadeIn className="lg:col-span-4 space-y-6">
            ...
            <div>
              ...
              <a
                ...
                className="company-body mt-2 inline-flex items-center gap-2 font-medium hover:opacity-80 cursor-pointer"
                style={{ color: brand.primary === "#0a0a0a" ? brand.accent : brand.primary }}
              >
              ...
              <ul className="grid gap-3 sm:grid-cols-2">
                {company.capabilities.map((cap) => (
                  <li
                    ...
                    style={{
                      borderColor: `color-mix(in srgb, ${brand.accent} 22%, #e2e8f0)`,
                    }}
                  >
                    <Check
            ...
            <FadeIn>
              ...
              <ul className="space-y-3">
                {company.credentials.map((cred) => (
                  <li
                    key={cred}
                    className="company-body border-l-2 pl-4 text-[15px] text-mono-70"
            ...
            {others.map((c) => (
              <StaggerItem key={c.slug}>
                <Link
                  ...
                  className={`group flex items-center gap-4 rounded-2xl border border-mono-20 bg-white p-5 transition-colors hover:border-mono-30 cursor-pointer ${c.brand.themeClass}`}
                >
